        ...
        <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row">
            ...
            <aside className="hidden md:flex w-72 bg-[#0B1221] flex-col p-6 text-white shrink-0">
                ...
                <nav className="flex-grow space-y-2">
                    <a href="#" className="flex items-center gap-3 px-4 py-3 bg-[#FBC02D]/10 text-[#FBC02D] rounded-xl font-bold transition-all">
                        <LayoutDashboard className="w-5 h-5" />
                        Dashboard
                    </a>
                    <a href="#" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all group">
                        <Users className="w-5 h-5 group-hover:text-[#FBC02D]" />
                        Indicações
                    </a>
                    <a href="#" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all group">
                        <Wallet className="w-5 h-5 group-hover:text-[#FBC02D]" />
                        Financeiro
                    </a>
                    <a href="#" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl font-medium transition-all group">
                        <TrendingUp className="w-5 h-5 group-hover:text-[#FBC02D]" />
                        Relatórios
                    </a>
                </nav>
